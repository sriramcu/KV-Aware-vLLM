...
LM_CACHE_LOCAL_DISK = os.environ.get("SC_LMCACHE_LOCAL_DISK_ENABLE", "1").strip().lower() in ("1", "true", "yes", "on")
LM_CACHE_MAX_LOCAL_DISK_SIZE = float(
    os.environ.get("SC_LMCACHE_MAX_LOCAL_DISK_SIZE", "450.0")
)
