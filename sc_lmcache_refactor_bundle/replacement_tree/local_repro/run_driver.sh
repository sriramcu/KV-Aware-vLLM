...
# LMCache experimental controls are intentionally not hard-coded here.
# Source local_repro/sc_lmcache_knobs.sh in the sbatch script, or export any
# SC_* variables before invoking this driver. Unset controls use Python defaults
# that keep custom gates and custom tracing disabled.
...
# export SC_LMCACHE_DATA_DIR="$RUN_ROOT/lmcache_vllm/${JOB_TAG}"
